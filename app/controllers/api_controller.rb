class ApiController < ApplicationController
  ...
  def messages
    ...
    if params[:codes].present?
      ...
      @messages =   Message.published.includes(:photos_files).for_app.by_group_and_student_ids(groups_ids, student_ids).order(updated_at: :desc).limit(30) #.includes(:mfiles)
